    ...
    return (
        <div className='bg-white rounded-lg shadow-md w-full'>
            <div className='flex items-center justify-between bg-gray-200 px-4 py-3 rounded-t-lg'>
                ...
                <div>
                    <button class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-1 px-4 mr-3 rounded-md transition-colors duration-200 ease-in-out" onClick={createTraining}>Create New Training</button>
